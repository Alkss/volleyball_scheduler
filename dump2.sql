...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 21-Dez-2021 às 14:40
...
--
-- Truncar tabela antes do insert `available_days`
--

TRUNCATE TABLE `available_days`;
--
-- Extraindo dados da tabela `available_days`
--

INSERT DELAYED INTO `available_days` (`id`, `code`, `name`) VALUES
(1, 'SUN', 'Sunday'),
(2, 'MON', 'Monday'),
(3, 'TUE', 'Tuesday'),
(4, 'WED', 'Wednesday'),
...
--
-- Truncar tabela antes do insert `court`
--
...
INSERT DELAYED INTO `court` (`id`, `day`, `players`, `datetime`, `isOpen`, `isScheduled`, `scheduleDatetime`, `max_Players`) VALUES
...
--
-- Truncar tabela antes do insert `day`
--
...
INSERT DELAYED INTO `day` (`id`, `owner`, `matchDay`) VALUES
(1, 1, 1),
(2, 1, 5),
(3, 1, 2);
...
--
-- Truncar tabela antes do insert `day_user`
--

TRUNCATE TABLE `day_user`;
-- --------------------------------------------------------
...
--
-- Truncar tabela antes do insert `players`
--
...
INSERT DELAYED INTO `players` (`id`, `name`, `isRemoved`, `isWaitingList`, `removedBy`, `datetime_inserted`) VALUES
...
--
-- Truncar tabela antes do insert `players_court`
--

TRUNCATE TABLE `players_court`;
--
-- Extraindo dados da tabela `players_court`
--

INSERT DELAYED INTO `players_court` (`id`, `player`, `court`) VALUES
(2, 2, 10),
(3, 3, 10),
(4, 4, 10);
...
INSERT DELAYED INTO `user` (`id`, `name`, `email`, `password`, `isAdmin`) VALUES
